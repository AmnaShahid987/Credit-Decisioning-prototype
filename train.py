...
cols_to_drop = ['customer_id', 'final_risk_label','base_risk_score','life_stability_score','life_stability_score_adj', 'probability_of_default'] + [c for c in df.columns if c.startswith('prob_')]
